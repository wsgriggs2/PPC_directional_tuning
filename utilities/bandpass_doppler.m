function [Dop_bandpass, d] = bandpass_doppler(Dop, fpass, fs, varargin)
...
if ndims(Dop) == 3
    ...
    [dataOut, d] = bandpass(dataOut', fpass, fs, ...
    ...
    Dop_bandpass = permute(dataOut, [2, 1, 3]);
...
elseif ndims(Dop) == 4
    ...
    Dop_bandpass = permute(dataOut, [2, 1, 4, 3]);
end
end