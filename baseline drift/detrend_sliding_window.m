function dop  = detrend_sliding_window(dop, window_length)
% dop  = detrend_sliding_window(dop, window_length)
%
...
%% the business
thepool = gcp;
H = ProgressBar(yPixels, task=sprintf('Detrend sliding window (%i samples)', window_length));
for y = 1:yPixels    
    parfor x = 1:xPixels
